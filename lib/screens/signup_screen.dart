...
class _SignupScreenState extends State<SignupScreen>
                ...
                Row(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 13,
                        color: const Color(0xFF2B4236).withValues(alpha: 0.6),
                      ),
                    ),
                    GestureDetector(
  ...
  Widget _buildTextField({
    ...
    return TextField(
      ...
      enabled: enabled,
      style: const TextStyle(fontSize: 15, color: Color(0xFF2B4236)),
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(14),
          borderSide: const BorderSide(color: Color(0xFF2B4236), width: 1.5),
        ),
      ),
    );
  }
